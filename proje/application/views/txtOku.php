...
<div class="wrapper">
	...
	<header class="main-header">
		...
		<nav class="navbar navbar-static-top" style="background-color: ">
			...
			<p style="text-align: center; font-size: large;color: white">Bu alanda Sadece Metin Belgesi Verileri Yüklenebilir. (.TXT)</p>
						...
						<div class="fakulte_align-content">
							<div class="fakulte_content">
								...
								<div class="error box">
									...
									<p class="fa fa-arrow-right">Fakülte ve bölümlerin hatasız yüklenmesi için Metin belgesi sırası <br> fakulte - bolum - bolum_tur şeklinde olmalıdır.</p>
									<p class="fa fa-arrow-right"> <b style="color: red">örn: Mühendislik Fakültesi-Bilgisayar Mühendisliği-N.Ö</b>  şeklinde olmalıdır.</p>
								</div>


								<form method="post" action="<?php echo base_url("home/fakultetxt"); ?>" enctype="multipart/form-data">
									<h4>Yükleme işlemi için <b>Metin</b> Belgesini Seçiniz </b></h4>
									<input type="file" name="fakultefile" id="file" required accept=".txt" /></p>
									<br />
						...
						<div class="cevap_anahtari_align-content">
							<div class="cevap_anahtari_content">
								...
								<div class="error boxx">
									...
									<p  class="fa fa-arrow-right">Verilerin Metin Belgesi sırası "tc-s1-s2-s3-s4-s5-s6-s7-s8-s9-s10-s11-s12-s13-s14-s15-s16-s17-s18-s19-s20" şeklinde olmalıdır.</p>
									<p  class="fa fa-arrow-right"> <b style="color: red"> örn: "111111111111-A-B-C-D-E-C-D-A-A-B-C-E-A-D-B-C-E-D-D-E"</b> şeklinde olmalıdır.</p>
								</div>
								...
								<form action="<?php echo base_url("cevapanahtariyukle/import") ?>"  method="post" id="cevapAnahtariyukle" enctype="multipart/form-data">
									...
									<h4>Yükleme işlemi için <b>Metin</b> Belgesini Seçiniz </b></h4>
									<input type="file" name="file" id="file" required accept=".txt" /></p>
									<br />
									<input style="background-color: #a32d00; color: white; font-size:medium" type="submit" name="import" value="Verileri Yükle" />
								</form>
